...
(function ($, document) {
    $.glisse = function (element, options) {
        ...
        var createElements = function createElements() {
            ...
            plugin.els['wrapper']       = $(document.createElement('div')).attr('id','glisse-wrapper').css('z-index', plugin.settings.zindex);
            ...
            plugin.els['controls']      = $(document.createElement('div')).attr('id','glisse-controls')
                                            .css(cssProp, cssVal).css('z-index', (plugin.settings.zindex + 10));
            if(plugin.settings.bootstrap) {
            	plugin.els['controlNext']   = $(document.createElement('span')).attr('class','glisse-next right carousel-control')
	                                            .append( $(document.createElement('a')).attr("href", "#")
	                                            		.append($(document.createElement('span'))
	                                            				.attr('class', 'glyphicon glyphicon-chevron-right')
	                                            				.attr('aria-hidden', 'true'))
	                                            		.append($(document.createElement('span'))
	                                            				.attr('class', 'sr-only').html(plugin.settings.bootstrapl18nNext)))
	                                            .css('z-index', (plugin.settings.zindex + 20));
            	plugin.els['controlPrev']   = $(document.createElement('span')).attr('class','glisse-prev left carousel-control')
            									.append($(document.createElement('a')).attr("href", "#")
									            		.append($(document.createElement('span'))
